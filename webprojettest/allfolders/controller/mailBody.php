                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tbody>
                                                            <tr valign="top">
                                                                ...
                                                                <td>
                                                                    <center> <a style="display:block; margin:0 0 14px;" href="https://localhost/webprojettest/allfolders/views/front/blogs-details.php?idNewsArticle={{ idNewsArticle0 }}"><img src="https://2aszhi3llh0x466uws21w6cc-wpengine.netdna-ssl.com/wp-content/uploads/writing-new-blog-post-1024x682.jpg" style="width:50%;"></a></center>
                                                                    <p style=" font-size:14px; line-height:22px; font-weight:bold; color:#333333; margin:0 0 5px;"><a href="https://localhost/webprojettest/allfolders/views/front/blogs-details.php?idNewsArticle={{ idNewsArticle0 }}" style="color:#6c7e44; text-decoration:none;">{{ titre0 }}</a></p>
                                                                </td>
                                                            ...
                                                            <tr valign="top">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    400005 Russian Federation, Volgograd, prospekt Lenina 56--><br>
                                                                        ...
                                                                        Website: <a href="https://localhost/webprojettest/allfolders/views/front/index.php" style="color:#6d7e44; text-decoration:none; font-weight:bold;">www.Virupedia.com</a>
                                                                    </p>
                                                                </td>
                                                                <td width="30">
                                                                    <p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p>
                                                                ...
                                                                <td width="120">
                                                                    ...
                                                                    <a href="https://localhost/webprojettest/allfolders/views/front/index.php" style="color:#6d7e44; text-decoration:none;">Visit website</a><br>
                                                                    </p>
                                                                </td>
                                                                <td width="30">
                                                                    <p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p>
