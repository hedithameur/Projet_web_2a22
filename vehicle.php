<?php
    ...
    $bdo = new PDO("mysql:host=127.0.0.1;bdname=projet;charset=utf8","root","");
    ...
    $likes = $bdo->prepare("SELECT id FROM likes ");
    //$likes->execute(array($id));
    $likes = $likes->rowCount();

    $dislikes = $bdo->prepare("SELECT id FROM dislikes ");
            ...
            <section id="car-1-header">
                <div class="container">
                    <nav role="navigation">
                        ...
                        <h1 id="car-1-logo"><a href="assets/index.html"><img src="assets/images/logoSamsara.png"></a></h1>
...
-->                                     
    ...
    <div class="vote_btns animate-box">
        <form action="action.php?t=1&id=<?= $produit['matricule'];?>" method="POST">
        <button type="submit" class="vote_btn vote_like  btn btn-primary "
        href="action.php?t=1&id=<?= $produit['matricule'];?>">
            <i class="fa fa-thumbs-up"></i> <?= $likes ?></button>
            </form>                                

        <form action="action.php?t=2&id=<?= $produit['matricule'];?>"" method="POST">
        <button type="submit" class="vote_btn vote_dislike btn btn-primary"
        href="action.php?t=2&id=<?= $produit['matricule'];?>">
            <i class="fa fa-thumbs-down"></i> <?= $dislikes ?></button>
            </form> 
    </div>                                    
    </div>
<!--
        <a href="action.php?t=1&id=<?= $produit['matricule'];?>"> Like </a> (<?= $likes ?>)
        <br/>
        <a href="action.php?t=2&id=<?= $produit['matricule'];?>"> Dislike </a> (<?= $dislikes ?>)
