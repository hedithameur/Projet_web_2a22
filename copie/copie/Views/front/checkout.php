						...
						<form action="#">
							...
							<div class="row">
								...
								<div class="col-lg-9">
									...
									<input type="text" placeholder="Apartment, suite, unite ect (optinal)" class="sm-mt-30" />
								</div>
							</div>
							<div class="row">
								<div class="col-lg-3">
                ...
                <div class="order-details mt-30 sm-mt-50">
						...
						<div class="order-details-inner">
								...
								<?PHP 
                                   ...
                                   ?>
                                     <tr>
										...
										<td><strong><?PHP echo $panier['prix']; ?></strong> TND</td>
									</tr>
                                             <?php }
                                              ?>
							...
							<div class="payment-gateways mt-30">
								...
								<div class="single-payment-gateway">
									<input type="radio" id="system4" />
									<label for="system4">E-Dinnars</label>
								</div>
							</div>
							<div class="place-order text-center mt-60">
								<button href="#" onclick="addCart()" class="btn-common width-180">place order</button>
							</div>
						</div>
