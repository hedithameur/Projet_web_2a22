                                        ...
                                        <div class="col-lg-10 col-xl-8">
                                            <div class="cart-container">
                                                ...
                                                <div class="cart-footer text-right">
                                                    <a href="ajouterCommande.php?id_panier=<?php echo $id_panier;?>&prix=<?php echo $prixFinale; ?>" class="btn btn-success my-1">Proceed to Checkout<i class="ri-arrow-right-line ml-2"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
