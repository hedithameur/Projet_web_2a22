<?PHP
	...
	class commandeC {
		...
		function ajoutercommande($commande){
			$sql="INSERT Into commande (id_user  , prix , mode_paiement) 
			VALUES (:id_user, :prix , :mode_paiement)";
		...
		function search($str){
			...
			$sql="SELECT * FROM commande where id_user like '%".$str."%' or prix like '%".$str."%' or mode_paiement like '%".$str."%' ";
			$db = config::getConnexion();
			try{
				$liste = $db->query($sql);
				return $liste;
