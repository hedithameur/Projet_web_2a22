                ...
                <div class="car-1-intro no-js-fullheight">
                    <div class="car-1-intro-text slider-contnt">
                        <div class="car-1-center-position">
                            <h3 class="animate-box">Our <span>Products</span></h3>
                            <h4 class="animate-box fadeInUp animated">exemple liste des produits</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row row-bottom-padded-md">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <h2 class="car-1-lead animate-box">exemple produits</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xxs-12 animate-box">
                        <div class="car-1-project-item">
                            <img src="images/audi.png" alt="Image" class="img-responsive">
                            <div class="car-1-text">
                                <h3>pdoduit 1 - 100.000 TND</h3>

                                <!--<a href="ajoutePanierLine.php?id_produit=1&Qte=1&prix=10"><button>Ajouter au panier</button></a>-->
                                <a href="ajoutePanierLine.php?id_produit=1&Qte=1&prix=10" class="btn btn-primary">Ajouter au panier</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xxs-12 animate-box">
                        <div class="car-1-project-item">
                            <img src="images/trip-plan.jpg" alt="Image" class="img-responsive">
                            <div class="car-1-text">
                                <h3>produit 2 - 120.000 TND</h3>
                                <!--<a href="ajoutePanierLine.php?id_produit=2&Qte=1&prix=120"><button>Ajouter au panier</button></a>-->
                                <a href="ajoutePanierLine.php?id_produit=1&Qte=1&prix=10" class="btn btn-primary">Ajouter au panier</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xxs-12 animate-box">
                        <div class="car-1-project-item">
                            <img src="images/rent-car-1.jpg" alt="Image" class="img-responsive">
                            <div class="car-1-text">
                                <h3>produit 3 - 80.000 TND</h3>
                              <!--  <a href="ajoutePanierLine.php?id_produit=3&Qte=1&prix=80"><button>Ajouter au panier</button></a>-->
                              <a href="ajoutePanierLine.php?id_produit=1&Qte=1&prix=10" class="btn btn-primary">Ajouter au panier</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xxs-12 animate-box">
                        <div class="car-1-project-item">
                            <img src="images/rolls-royce.jpg" alt="Image" class="img-responsive">
                            <div class="car-1-text">
                                <h3>produit 4 - 180.000 TND</h3>
                              <!--  <a href="ajoutePanierLine.php?id_produit=3&Qte=1&prix=80"><button>Ajouter au panier</button></a>-->
                              <a href="ajoutePanierLine.php?id_produit=1&Qte=1&prix=10" class="btn btn-primary">Ajouter au panier</a>
                            </div>
                        </div>
