    ...
    <div id="car-1-page">
        ...
        <section id="car-1-hero" class="no-js-fullheight" style="background-image: url(images/slider-4.jpg);" data-next="yes">
                ...
                <div class="car-1-intro no-js-fullheight">
                    <div class="car-1-intro-text slider-contnt">
                        <div class="car-1-center-position">
                            <h3 class="animate-box"> <span>Order Complete</span></h3>
                        </div>
                    </div>
                </div>
            </div>
            <div class="car-1-learn-more animate-box">
        	                                                ...
        	                                                <!--Partie Panier -->
	<!--order-comlete-area start-->
            	<div class="order-complete-area mt-100 sm-mt-80 text-center">
		<div class="container">
			<div class="row">
								 ...
								 foreach($listeU as $panier)
									{ 
            ?>
                        <p>Merci d'avoir choisi notre site. L'id de votre panier est <span><?php echo $panier['id'] ?></span>, il vous sera livré dans les prochaines 72h.</p>
                ...
                ?>
                                            ...
                                            <a href="vehicle.php" class="btn btn-primary">CONTINUE SHOPPING</a>
                                        </div>
                
			</div>
		</div>
	</div>
	<!--order-comlete-area end-->
