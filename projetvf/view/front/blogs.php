...
<html class="no-js">
    ...
    <body>
        ...
        <div id="car-1-page">
            ...
            <section id="car-1-header">
                <div class="container">
                    <nav role="navigation">
                        ...
                        <h1 id="car-1-logo"><a href="index.html"><img src="images/logo.png"></a></h1>
            ...
            <?php require_once "C://xampp/htdocs/webprojettest/allfolders/controller/ajouterArticle.php";
                    ...
                    <div class="car-1-intro no-js-fullheight">
                        <div class="car-1-intro-text slider-contnt">
                            <div class="car-1-center-position">
                                <h3 class="animate-box">Our <span>Blogs</span></h3>
                                <h4 class="animate-box fadeInUp animated"></h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- dropdown -->
            <?php require_once 'C://xampp/htdocs/webprojettest/allfolders/views/front/dropdown.php'; ?>
            <!-- //dropdown -->
            <section id="car-1-projects" class="service-sec">
                <div class="container">
                    <div class="row row-bottom-padded-md">
                        <div class="col-md-8 col-md-offset-2 text-center">
                            <h2 class="car-1-lead animate-box">We Provide More Services</h2>
                            <p class="car-1-sub-lead animate-box">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xxs-12 animate-box">
                            <a href="../../../webprojettest/allfolders/views/front/blogs-details.php?idNewsArticle=<?PHP echo $row['idNewsArticle']; ?>" class="car-1-project-item">
                                <img src="images/<?PHP echo $row['urlImage']; ?>" alt="Image" class="img-responsive">
