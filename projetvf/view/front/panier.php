<?php
    ...
    $listeU = $panierC->afficherpanierline($id_user);
    $subTotale = 0;
  //  $couponValue=0;
...
if (isset($_POST['coupon'])) {
    $coupon = $panierC->recupererCoupon($_POST['coupon']);
    if (isset($coupon)) {
            ...
            <div class="container">
                <nav role="navigation">
                    <ul class="pull-left left-menu">
                        ...
                        <li class="active"><a href="blogs.php">Blogs</a>
                        </li>
                                        ...
                                        <div class="col-lg-10 col-xl-8">
                                            <div class="cart-container">
                                                            ...
                                                            <?php
                                                             ...
                                                             ?>
                                                                <tr>
                                                                    ...
                                                                    <td><a href="supprimerPanierLine.php?id=<?php echo $panier['id']; ?>" class="text-danger"><i class="ri-delete-bin-3-line"></i></a>
                                                                    
                                                                    <td><?php echo $panier['id_produit']; ?></td>
                                                                    <td>
                                                                        <div class="form-group mb-0">
                                                                            <form method="POST" action="modifierPanierLine.php">
                                                                                
                                                                                <input type="hidden" name="id" value="<?php echo $panier['id']; ?>">
                                                                                <input type="number" class="form-control cart-qty" name="Qte" id="cartQty1" value="<?php echo $Qte; ?>" >
                                                                </td>
                                                                <td> 
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <div class="input-group-append">
                                                                                <button class="btn btn-primary" type="submit" id="button-addonTags">Apply</button>
                                                ...
                                                <div class="cart-footer text-right">
                                                    <a href="checkout.php" class="btn btn-primary<?= ($subTotale > 1)?'':'disabled';?>">Proceed to Checkout<i class="ri-arrow-right-line ml-2"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
